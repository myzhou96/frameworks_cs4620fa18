...
public class Group extends Surface {
  ...
  public void setTransformation(Matrix4d pMat, Matrix4d pMatInv, Matrix4d pMatTInv) {
    // #A7: Compute tMat, tMatInv, tMatTInv using transformMat.
    ...
    // #A7: Call setTransformation(tMat, tMatInv, tMatTInv) on each of the children.
  ...
  public void setRotate(Vector3d R) {
    // #A7: add rotation to transformMat
